...
test('renders only title and author by default', () => {
  ...
  render(<Blog key={blog.id} blog={blog} callBack={mockHandler} setNotification={mockHandler} user={blog.user} />)
...
test('callback is fired twice, when like button is clicked twice', async () => {
  ...
  render(<Blog key={blog.id} blog={blog} callBack={mockHandler} setNotification={mockHandler} user={blog.user} likeMock={mockHandler} />)
