...
describe('favorite blog', () => {
  test('of empty list is dummy object', () => {
    ...
    expect(result).toEqual({ title: '', author: '', likes: -1 })
  })
  ...
  test('of a bigger list is the correct favorite', () => {
...
describe('most blogs', () => {
  ...
  test('of a bigger list is the correct author and amount', () => {
...
describe('most likes', () => {
  test('of empty list is dummy object', () => {
    ...
    expect(result).toEqual({ author: '', likes: -1 })
  })

  test('when list only has one blog is the author of that', () => {
